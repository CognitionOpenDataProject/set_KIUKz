...
We ran two-way repeated measures ANOVA on accuracy (d') with task type and orientation as factors. We also ran an ANOVA on % accuracy change with face orientation with task type as a factor.
